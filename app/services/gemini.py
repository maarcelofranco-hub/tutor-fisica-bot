...
class GeminiService:
    ...
    def _build_prompt(self, student_answer: str, answer_key: str | None) -> str:
        ...
        prompt += "Avalie se a resposta do aluno está correta. Retorne a resposta no formato JSON estrito com as chaves: 'is_correct' (boolean), 'feedback' (string) e 'explanation' (string)."
        return prompt
